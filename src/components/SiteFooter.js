...
export default function SiteFooter() {
  return (
    <footer className="about-footer" aria-label="Site footer">
      ...
      <div className="about-footer-inner">
        ...
        <div className="about-footer-bottom">
          ...
          <nav
            className="about-footer-links about-footer-socials"
            aria-label="Social links"
          >
            <a
              href="https://linkedin.com/in/naoliu"
              target="_blank"
            ...
            <a
              href="https://facebook.com/naoballs"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="Facebook"
              title="Facebook"
            ...
            <a
              href="https://instagram.com/naoestherliu"
              target="_blank"
              rel="noopener noreferrer"
